<li <?php echo e($attributes->merge(['class' => 'flex text-base'])); ?>>
    <span <?php echo e($attributes->merge(['class' => 'text-nw-blue-700 mr-2.5 mt-0.5'])); ?>>
    ...
    </span><p> <?php echo e($slot); ?></p>

</li>
<?php /**PATH D:\LaravelNWFP\NWFP2024-001\resources\views/components/li-arrow.blade.php ENDPATH**/ ?>